...
PLUGIN_AUTHORS = ['eliott <eliott@cactuswax.net>',] 
PLUGIN_VERSION = '0.1'
PLUGIN_DESCRIPTION = r"""This plugin will drop a file in the .exaile dir (called nowplaying.txt) with information about the current playing song."""
